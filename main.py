...
marker_points_list = get_interpolated_marker_points(
    a_points_list, b_points_list, total_frames)
...
# add reversed frames to overlayed_frames to loop backwards
# print(type(overlayed_frames))
reversed_list = overlayed_frames[::-1]
overlayed_frames.extend(reversed_list)
# print("reversed_frames", reversed_frames)


# Save overlayed_frames as gif
...
print(type(overlayed_frames))
imageio.mimsave('./morph.gif', np.array(overlayed_frames), loop=0)
